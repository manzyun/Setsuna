...
from .. import app
from ..models import post_factory, serial_json
...
def get_post(uid: str):
    ...
    return Resonse(json.dumps(post), 200)
...
def post_content():
    ...
    post = models.Post(content=req['content'],
                        password=req['password'] if '' None,
                        lang=req['lang'] if '' None)
    post.post_content()
